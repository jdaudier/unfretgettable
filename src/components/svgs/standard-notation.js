...
const NoteGrouping = styled.g`
    display: ${props => props.noteIds && props.ids.some(id => props.noteIds.indexOf(id) > -1) ? 'block' : 'none'}
`;
...
const NotePath = styled.path`
    fill: #363637;
	display: ${props => !props.ids || props.ids.some(id => props.noteIds.indexOf(id) > -1) ? 'block' : 'none'}
`;

class StandardNotation extends Component {
	render () {
		...
		return (
			<SVG version="1.1" x="0px" y="0px" viewBox="0 0 350 423">
				...
				<NoteGrouping ids={["e6s"]} noteIds={noteIds}>
				...
				<NoteGrouping ids={["f6s1f"]} noteIds={noteIds}>
				...
				<NoteGrouping ids={["f6s2f"]} noteIds={noteIds}>
					<g>
						<NotePath d="M215.6,346.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
								C187.6,350.8,206.2,346.9,215.6,346.9z M219.3,378.6c5.9-0.8,8.1-3.4,7.7-11.4c-0.7-11-7.6-18.5-14.4-17.4
								c-5.7,1-8.1,3.1-7.7,11.1C205.5,371.9,212.5,379.7,219.3,378.6z" />
			...
			l5-1.4v13.4h2.2v-14l3.5-0.9V368l-3.5,0.9v-11.4L177.7,356.5z M172,369.5l-5,1.3v-11.4l5-1.4V369.5z" />
				...
				<NoteGrouping ids={["g6s3f", "g6s3f2fin"]} noteIds={noteIds}>
				...
				<NoteGrouping ids={["a5s"]} noteIds={noteIds}>
				...
				<NoteGrouping ids={["b5s2f", 'b5s2f1fin']} noteIds={noteIds}>
				...
				<NoteGrouping ids={["c5s3f"]} noteIds={noteIds}>
				...
				<NotePath ids={["d4s"]} noteIds={noteIds} d="M215.6,258.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath ids={["e4s2f", "e4s2f1fin", "e4s2f3fin"]} noteIds={noteIds} d="M215.6,242.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath ids={["f4s3f"]} noteIds={noteIds} d="M215.6,224.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NoteGrouping ids={["f4s4f"]} noteIds={noteIds}>
				...
				<NotePath ids={["g3s"]} noteIds={noteIds} d="M215.6,206.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath ids={["a3s2f", "a3s2f1fin"]} noteIds={noteIds} d="M215.6,187.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath ids={["b2s"]} noteIds={noteIds} d="M215.6,170.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath ids={["c2s1f"]} noteIds={noteIds} d="M215.6,151.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NoteGrouping ids={["c2s2f"]} noteIds={noteIds}>
					<NotePath d="M215.6,151.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
		C187.6,155.8,206.2,151.9,215.6,151.9z M219.3,183.6c5.9-0.8,8.1-3.4,7.7-11.4c-0.7-11-7.6-18.5-14.4-17.4
		c-5.7,1-8.1,3.1-7.7,11.1C205.5,176.9,212.5,184.7,219.3,183.6z" />
					<g>
						<Polygon points="167,175.8 172,174.5 172,163 167,164.4" />
						<NotePath d="M177.7,161.5v-7.6l-3.5,0.9v-14.4H172v15l-5,1.3v-14.4h-2.2v15l-3.9,1v7.7l3.9-1v11.3l-3.9,1v7.7l3.9-1v13.3h2.2v-13.9
			l5-1.4v13.4h2.2v-14l3.5-0.9V173l-3.5,0.9v-11.4L177.7,161.5z M172,174.5l-5,1.3v-11.4l5-1.4V174.5z" />
					</g>
				</NoteGrouping>
				<NotePath ids={["d2s3f"]} noteIds={noteIds} d="M215.6,134.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath ids={["e1s"]} noteIds={noteIds} d="M215.6,115.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath ids={["f1s1f"]} noteIds={noteIds} d="M215.6,98.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NoteGrouping ids={["f1s2f", "f1s2f3fin"]} noteIds={noteIds}>
				...
				<NotePath ids={["g1s3f", "g1s3f4fin"]} noteIds={noteIds} d="M215.6,81.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
