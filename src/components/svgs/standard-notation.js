		...
		return (
			<div css={styles.artboard}>
				...
				<div css={row}>
					...
					<div css={cell({noBorder: true, noteCol: true})}>
						<NoteSVG ids={[[1, 6], [1, 7]]} noteIds={noteIds} />
						<NoteSVG stepUp ids={[[1, 8]]} noteIds={noteIds} />
						<div css={line({
							ids: [[1, 8]],
							noteIds
						})} />
				...
				<div css={row}>
					...
					<div css={cell}>
						...
						<SharpSVG stepDown ids={[[2, 1, 's']]} noteIds={noteIds} />
						<FlatSVG stepDown ids={[[2, 0, 'f'], [3, 3, 'f']]} noteIds={noteIds} />
					</div>
					<div css={cell({noteCol: true})}>
						<NoteSVG ids={[[2, 1], [2, 2, 's'], [3, 5], [3, 6]]} noteIds={noteIds} />
						<NoteSVG stepDown ids={[[2, 0], [2, 0, 'f'], [2, 1, 's'], [3, 3, 'f'], [3, 4]]} noteIds={noteIds} />
					</div>
					<div css={cell({lastCol: true})} />
				</div>
				<div css={row}>
				...
				<div css={row}>
					...
					<div css={cell}>
						...
						<FlatSVG stepDown ids={[[4, 1, 'f'], [4, 2, 'f']]} noteIds={noteIds} />
					</div>
					<div css={cell({noteCol: true})}>
						<NoteSVG ids={[[4, 3], [4, 3, 'f'], [4, 3, 's'], [4, 4], [4, 4, 's']]} noteIds={noteIds} />
						<NoteSVG stepDown ids={[[4, 1, 'f'], [4, 2], [4, 2, 'f']]} noteIds={noteIds} />
					</div>
					<div css={cell({lastCol: true})} />
				</div>
				<div css={row}>
					<div css={cell({noBorder: true})} />
					<div css={cell({noBorder: true})}>
						<SharpSVG stepDown ids={[[5, 4, 's']]} noteIds={noteIds} />
						<SharpSVG ids={[[4, 1], [4, 1, 's']]} noteIds={noteIds} />
					</div>
					<div css={cell({noBorder: true, noteCol: true})}>
						<NoteSVG ids={[[4, 0], [4, 1], [4, 1, 's']]} noteIds={noteIds} />
						<NoteSVG stepDown ids={[[5, 4, 's'], [5, 3]]} noteIds={noteIds} />
						<div css={line({
							stepDown: true,
							ids: [[5, 4, 's'], [5, 3], [5, 2], [5, 1, 'f'], [5, 0], [6, 4], [6, 3], [6, 1], [6, 2], [6, 0]],
							noteIds
						})} />
					</div>
					<div css={cell({noBorder: true, lastCol: true})} />
