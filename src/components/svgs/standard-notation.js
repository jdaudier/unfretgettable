...
const NotePath = styled.path`
    fill: #363637;
	display: ${props => !props.id || (props.noteIds && props.noteIds.indexOf(props.id) > -1) ? 'block' : 'none'}
`;
	...
	render () {
		...
		return (
			<SVG version="1.1" x="0px" y="0px" viewBox="0 0 350 423">
				...
				<NoteGrouping id="e6s" noteIds={noteIds}>
				...
				<NoteGrouping id="f6s1f" noteIds={noteIds}>
				...
				<NoteGrouping id="f6s2f" noteIds={noteIds}>
					<g>
						<NotePath d="M215.6,346.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
								C187.6,350.8,206.2,346.9,215.6,346.9z M219.3,378.6c5.9-0.8,8.1-3.4,7.7-11.4c-0.7-11-7.6-18.5-14.4-17.4
								c-5.7,1-8.1,3.1-7.7,11.1C205.5,371.9,212.5,379.7,219.3,378.6z" />
			...
			l5-1.4v13.4h2.2v-14l3.5-0.9V368l-3.5,0.9v-11.4L177.7,356.5z M172,369.5l-5,1.3v-11.4l5-1.4V369.5z" />
				...
				<NoteGrouping id="g6s3f" noteIds={noteIds}>
				...
				<NoteGrouping id="a5s" noteIds={noteIds}>
				...
				<NoteGrouping id="b5s2f" noteIds={noteIds}>
				...
				<NoteGrouping id="c5s3f" noteIds={noteIds}>
				...
				<NotePath id="d4s" noteIds={noteIds} d="M215.6,258.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath id="e4s2f" noteIds={noteIds} d="M215.6,242.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath id="f4s3f" noteIds={noteIds} d="M215.6,224.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NoteGrouping id="f4s4f" noteIds={noteIds}>
				...
				<NotePath id="g3s" noteIds={noteIds} d="M215.6,206.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath id="a3s2f" noteIds={noteIds} d="M215.6,187.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath id="b2s" noteIds={noteIds} d="M215.6,170.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath id="c2s1f" noteIds={noteIds} d="M215.6,151.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NoteGrouping id="c2s2f" noteIds={noteIds}>
		...
		c-5.7,1-8.1,3.1-7.7,11.1C205.5,176.9,212.5,184.7,219.3,183.6z" />
			...
			l5-1.4v13.4h2.2v-14l3.5-0.9V173l-3.5,0.9v-11.4L177.7,161.5z M172,174.5l-5,1.3v-11.4l5-1.4V174.5z" />
				...
				<NotePath id="d2s3f" noteIds={noteIds} d="M215.6,134.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath id="e1s" noteIds={noteIds} d="M215.6,115.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NotePath id="f1s1f" noteIds={noteIds} d="M215.6,98.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
				...
				<NoteGrouping id="f1s2f" noteIds={noteIds}>
				...
				<NotePath id="g1s3f" noteIds={noteIds} d="M215.6,81.9c9.8,0,28,3.5,28.4,17.3c0.4,13.5-18.1,17.3-27.6,17.3c-10.1,0-28-3.5-28.4-17.3
