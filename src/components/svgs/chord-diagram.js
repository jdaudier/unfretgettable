...
const WhitePath = styled.path`
    fill: #FFF;
    display: ${props => props.showNotes ? 'none' : 'block'}
`;
	...
	render() {
		...
		h35.3 M20.4,34.4v55.6" />
				...
				<Dot id="b5s2f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M60.7,125.5H47c0.2-1.3,0.6-2.6,1.4-3.8s2.3-2.6,4.5-4.2c1.3-1,2.2-1.7,2.6-2.3s0.6-1,0.6-1.5
				...
				<Dot id="b5s2f1fin" noteIds={noteIds}>
					<SolidCircle cx="55" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M57.7,108.8v16.7h-4.6v-10.9c-0.7,0.6-1.5,1-2.2,1.4c-0.7,0.4-1.6,0.7-2.6,1v-3.7c1.5-0.5,2.8-1.1,3.6-1.8
				c0.9-0.7,1.5-1.6,2-2.6H57.7z" />
				</Dot>
				<Dot id="c5s3f" noteIds={noteIds}>
					<SolidCircle cx="55" cy="174" r="16" />
					<WhitePath showNotes={showNotes} d="M51.8,169.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
				...
				<Dot id="f1s1f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M200.7,52.8v16.7h-4.6V58.6c-0.7,0.6-1.5,1-2.2,1.4c-0.7,0.4-1.6,0.7-2.6,1v-3.7c1.5-0.5,2.8-1.1,3.6-1.8
							c0.9-0.7,1.5-1.6,2-2.6H200.7z" />
				</Dot>
				<Dot id="c2s1f" noteIds={noteIds}>
					<SolidCircle cx="161" cy="62" r="16" />
					<WhitePath showNotes={showNotes} d="M163.7,52.8v16.7h-4.6V58.6c-0.7,0.6-1.5,1-2.2,1.4c-0.7,0.4-1.6,0.7-2.6,1v-3.7c1.5-0.5,2.8-1.1,3.6-1.8
							c0.9-0.7,1.5-1.6,2-2.6H163.7z" />
				</Dot>
				<Dot id="c2s2f" noteIds={noteIds}>
					<SolidCircle cx="163" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M168.7,125.5H155c0.2-1.3,0.6-2.6,1.4-3.8s2.3-2.6,4.5-4.2c1.3-1,2.2-1.7,2.6-2.3s0.6-1,0.6-1.5
		c0-0.5-0.2-0.9-0.6-1.3c-0.4-0.4-0.8-0.5-1.4-0.5c-0.6,0-1.1,0.2-1.4,0.5c-0.4,0.4-0.6,1-0.7,1.9l-4.6-0.4c0.2-1.3,0.5-2.3,1-3
		c0.5-0.7,1.1-1.3,2-1.7c0.9-0.4,2.1-0.6,3.6-0.6c1.6,0,2.8,0.2,3.7,0.5s1.6,0.9,2.1,1.7c0.5,0.8,0.8,1.6,0.8,2.5
		c0,1-0.3,2-0.9,2.9c-0.6,0.9-1.6,1.9-3.2,3c-0.9,0.6-1.5,1.1-1.8,1.3c-0.3,0.3-0.7,0.6-1.1,1h7.1V125.5z" />
				</Dot>
				<Dot id="c2s2f3fin" noteIds={noteIds}>
					<SolidCircle cx="163" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M160.8,113.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
				c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
				c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
				c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
				c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				...
				<Dot id="a3s2f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M132.7,125.5H119c0.2-1.3,0.6-2.6,1.4-3.8s2.3-2.6,4.5-4.2c1.3-1,2.2-1.7,2.6-2.3s0.6-1,0.6-1.5
							c0-0.5-0.2-0.9-0.6-1.3c-0.4-0.4-0.8-0.5-1.4-0.5c-0.6,0-1.1,0.2-1.4,0.5c-0.4,0.4-0.6,1-0.7,1.9l-4.6-0.4c0.2-1.3,0.5-2.3,1-3
							c0.5-0.7,1.1-1.3,2-1.7c0.9-0.4,2.1-0.6,3.6-0.6c1.6,0,2.8,0.2,3.7,0.5s1.6,0.9,2.1,1.7c0.5,0.8,0.8,1.6,0.8,2.5
							c0,1-0.3,2-0.9,2.9c-0.6,0.9-1.6,1.9-3.2,3c-0.9,0.6-1.5,1.1-1.8,1.3c-0.3,0.3-0.7,0.6-1.1,1h7.1V125.5z" />
				</Dot>
				<Dot id="a3s2f1fin" noteIds={noteIds}>
					<SolidCircle cx="127" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M129.7,108.8v16.7h-4.6v-10.9c-0.7,0.6-1.5,1-2.2,1.4c-0.7,0.4-1.6,0.7-2.6,1v-3.7c1.5-0.5,2.8-1.1,3.6-1.8
			c0.9-0.7,1.5-1.6,2-2.6H129.7z" />
				</Dot>
				<Dot id="a3s2f3fin" noteIds={noteIds}>
					<SolidCircle cx="127" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M124.8,113.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
				c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
				c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
				c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
				c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				c0.6,0,1.1-0.2,1.5-0.6s0.6-0.8,0.6-1.4c0-0.5-0.1-0.9-0.4-1.2c-0.3-0.3-0.7-0.4-1.2-0.4c-0.5,0-1,0.2-1.3,0.5
				C125.1,112.5,124.9,113,124.8,113.9z" />
				</Dot>
				<Dot id="e4s2f" noteIds={noteIds}>
					<SolidCircle cx="91" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M96.7,125.5H83c0.2-1.3,0.6-2.6,1.4-3.8s2.3-2.6,4.5-4.2c1.3-1,2.2-1.7,2.6-2.3s0.6-1,0.6-1.5
							c0-0.5-0.2-0.9-0.6-1.3c-0.4-0.4-0.8-0.5-1.4-0.5c-0.6,0-1.1,0.2-1.4,0.5c-0.4,0.4-0.6,1-0.7,1.9l-4.6-0.4c0.2-1.3,0.5-2.3,1-3
							c0.5-0.7,1.1-1.3,2-1.7c0.9-0.4,2.1-0.6,3.6-0.6c1.6,0,2.8,0.2,3.7,0.5s1.6,0.9,2.1,1.7c0.5,0.8,0.8,1.6,0.8,2.5
							c0,1-0.3,2-0.9,2.9c-0.6,0.9-1.6,1.9-3.2,3c-0.9,0.6-1.5,1.1-1.8,1.3c-0.3,0.3-0.7,0.6-1.1,1h7.1V125.5z" />
				</Dot>
				<Dot id="e4s2f1fin" noteIds={noteIds}>
					<SolidCircle cx="91" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M93.7,108.8v16.7h-4.6v-10.9c-0.7,0.6-1.5,1-2.2,1.4c-0.7,0.4-1.6,0.7-2.6,1v-3.7c1.5-0.5,2.8-1.1,3.6-1.8
			c0.9-0.7,1.5-1.6,2-2.6H93.7z" />
				</Dot>
				<Dot id="e4s2f3fin" noteIds={noteIds}>
					<SolidCircle cx="91" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M88.8,113.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
				c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
				c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
				c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
				c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				...
				<Dot id="g1s3f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M194.8,169.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
							c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
							c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
							c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
							c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				...
				<Dot id="g1s3f4fin" noteIds={noteIds}>
					<SolidCircle cx="198" cy="174" r="16" />
					<WhitePath showNotes={showNotes} d="M198.6,179.1h-8.3v-3.7l8.3-9.8h4v10.1h2.1v3.5h-2.1v3.1h-4V179.1z M198.6,175.6v-5.2l-4.4,5.2H198.6z" />
				</Dot>
				<Dot id="d2s3f" noteIds={noteIds}>
					<SolidCircle cx="162" cy="174" r="16" />
					<WhitePath showNotes={showNotes} d="M158.8,169.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
							c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
							c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
							c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
							c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				...
				<Dot id="f4s3f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M88.8,169.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
							c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
							c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
							c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
							c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				...
				<Dot id="f1s2f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M203.7,125.5H190c0.2-1.3,0.6-2.6,1.4-3.8s2.3-2.6,4.5-4.2c1.3-1,2.2-1.7,2.6-2.3s0.6-1,0.6-1.5
							c0-0.5-0.2-0.9-0.6-1.3c-0.4-0.4-0.8-0.5-1.4-0.5c-0.6,0-1.1,0.2-1.4,0.5c-0.4,0.4-0.6,1-0.7,1.9l-4.6-0.4c0.2-1.3,0.5-2.3,1-3
							c0.5-0.7,1.1-1.3,2-1.7c0.9-0.4,2.1-0.6,3.6-0.6c1.6,0,2.8,0.2,3.7,0.5s1.6,0.9,2.1,1.7c0.5,0.8,0.8,1.6,0.8,2.5
							c0,1-0.3,2-0.9,2.9c-0.6,0.9-1.6,1.9-3.2,3c-0.9,0.6-1.5,1.1-1.8,1.3c-0.3,0.3-0.7,0.6-1.1,1h7.1V125.5z" />
				</Dot>
				<Dot id="f1s2f3fin" noteIds={noteIds}>
					<SolidCircle cx="198" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M195.8,113.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
				c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
				c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
				c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
				c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				...
				<Dot id="f4s4f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M91.6,234.1h-8.3v-3.7l8.3-9.8h4v10.1h2.1v3.5h-2.1v3.1h-4V234.1z M91.6,230.6v-5.2l-4.4,5.2H91.6z" />
				</Dot>
				<Dot id="f6s2f" noteIds={noteIds}>
					<SolidCircle cx="20" cy="118" r="16" />
					<WhitePath showNotes={showNotes} d="M25.7,125.5H12c0.2-1.3,0.6-2.6,1.4-3.8s2.3-2.6,4.5-4.2c1.3-1,2.2-1.7,2.6-2.3s0.6-1,0.6-1.5
							c0-0.5-0.2-0.9-0.6-1.3c-0.4-0.4-0.8-0.5-1.4-0.5c-0.6,0-1.1,0.2-1.4,0.5c-0.4,0.4-0.6,1-0.7,1.9l-4.6-0.4c0.2-1.3,0.5-2.3,1-3
							c0.5-0.7,1.1-1.3,2-1.7c0.9-0.4,2.1-0.6,3.6-0.6c1.6,0,2.8,0.2,3.7,0.5s1.6,0.9,2.1,1.7c0.5,0.8,0.8,1.6,0.8,2.5
							c0,1-0.3,2-0.9,2.9c-0.6,0.9-1.6,1.9-3.2,3c-0.9,0.6-1.5,1.1-1.8,1.3c-0.3,0.3-0.7,0.6-1.1,1h7.1V125.5z" />
				</Dot>
				<Dot id="g6s3f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M16.8,169.9l-4.3-0.8c0.4-1.4,1-2.4,2.1-3.1c1-0.7,2.5-1.1,4.3-1.1c2.1,0,3.7,0.4,4.6,1.2
							c1,0.8,1.4,1.8,1.4,3c0,0.7-0.2,1.3-0.6,1.9c-0.4,0.6-1,1.1-1.8,1.5c0.6,0.2,1.1,0.3,1.5,0.5c0.5,0.3,1,0.8,1.3,1.3
							c0.3,0.5,0.5,1.2,0.5,2c0,1-0.2,1.9-0.7,2.7s-1.2,1.5-2.2,2c-0.9,0.5-2.2,0.7-3.7,0.7c-1.5,0-2.7-0.2-3.5-0.5
							c-0.9-0.3-1.6-0.9-2.1-1.5s-1-1.5-1.3-2.5l4.5-0.6c0.2,0.9,0.5,1.6,0.8,1.9s0.9,0.5,1.4,0.5c0.6,0,1.1-0.2,1.5-0.7
							c0.4-0.4,0.6-1,0.6-1.8c0-0.8-0.2-1.3-0.6-1.8c-0.4-0.4-0.9-0.6-1.6-0.6c-0.4,0-0.8,0.1-1.5,0.3l0.2-3.2c0.3,0,0.5,0.1,0.6,0.1
				...
				<Dot id="g6s3f2fin" noteIds={noteIds}>
					<SolidCircle cx="20" cy="174" r="16" />
					<WhitePath showNotes={showNotes} d="M26.7,181.5H13c0.2-1.3,0.6-2.6,1.4-3.8s2.3-2.6,4.5-4.2c1.3-1,2.2-1.7,2.6-2.3s0.6-1,0.6-1.5
				c0-0.5-0.2-0.9-0.6-1.3c-0.4-0.4-0.8-0.5-1.4-0.5c-0.6,0-1.1,0.2-1.4,0.5c-0.4,0.4-0.6,1-0.7,1.9l-4.6-0.4c0.2-1.3,0.5-2.3,1-3
				c0.5-0.7,1.1-1.3,2-1.7c0.9-0.4,2.1-0.6,3.6-0.6c1.6,0,2.8,0.2,3.7,0.5s1.6,0.9,2.1,1.7c0.5,0.8,0.8,1.6,0.8,2.5
				...
				<Dot id="f6s1f" noteIds={noteIds}>
					...
					<WhitePath showNotes={showNotes} d="M22.7,52.8v16.7h-4.6V58.6c-0.7,0.6-1.5,1-2.2,1.4c-0.7,0.4-1.6,0.7-2.6,1v-3.7c1.5-0.5,2.8-1.1,3.6-1.8
